...
<img src="{{site.url}}{{site.baseurl}}/img/sapi_fpm.png"/>
...
<img src="{{site.url}}{{site.baseurl}}/img/fcgi_fpm_content.png"/>
...
<img src="{{site.url}}{{site.baseurl}}/img/fpmarticlex.png"/>
...
<img src="{{site.url}}{{site.baseurl}}/img/FCGI_PARAMS.png"/>
...
<img src="{{site.url}}{{site.baseurl}}/img/params_articlex.png"/>
...
<img src="{{site.url}}{{site.baseurl}}/img/content_articlex.png"/>
在body信息读取阶段，对不同的Content-Type差异化处理的关键节点发生在sapi_read_post_data函数，见下图，展示了差异化处理的整体流程：
<img src="{{site.url}}{{site.baseurl}}/img/sapi_read_post_data.png"/>
...
<img src="{{site.url}}{{site.baseurl}}/img/sapi_read_standard_form_data.png"/>
...
<img src="{{site.url}}{{site.baseurl}}/img/php_startup_auto_globals.png"/>
...
<img src="{{site.url}}{{site.baseurl}}/img/php_auto_globals_create_post.png"/>
...
<img src="{{site.url}}{{site.baseurl}}/img/php_json_post_handler.png"/>
