...
https://github.com/blanchonvincent/ctxarg/blob/master/main.go

作者：Vincent Blanchon[6]译者：TomatoAres[7]校对：DingdingZhou[8]

本文由 GCTT[9] 原创编译，Go 中文网[10] 荣誉推出

参考资料
[1]
内置分析器: https://golang.org/cmd/vet/

[2]
上下文和通过传播进行取消: https://medium.com/@blanchon.vincent/go-context-and-cancellation-by-propagation-7a808bbc889c

[3]
反射包中的约定: http://golang.org/pkg/reflect/#StructTag
